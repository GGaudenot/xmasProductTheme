...
<div class="Module">
    <div class="headModule">
        <div class="menu">
        <h1 class="titre">- Les Produits de Noël -</h1>
        </div>
    <br/>
    <br/>
    <br/>
        <div class="sousMenu">
             <ul>
                <li><a class="lienMenu" href="#">Bottes</a>
                <a class="lienMenu" href="#">Talons</a>
                <a class="lienMenu" href="#">Chaussures</a>
                <a class="lienMenu" href="#">Autres</a></li>
             </ul>
        </div>
    </div>
